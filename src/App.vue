<template>
  <main class="main-content">
    ...
    <div class="main-content__grid">
      ...
      <div class="container">
        <button class="btn" @click="fairQuee">Rodar</button>
        <div class="tasks-grid">
          <div class="task" v-for="task in tasks" :key="task.id">
            ...
            <div v-if="task.running" class="task-content">
              <img
...
@Options({
  ...
  methods: {
    ...
    fairQuee() {
      // this.tasks = [];
      console.log("O ARRAY", this.tasks);

      // let processQuant = this.tasks.length;
      // this.tasks = this.tasks.map(
      //   (tk: Task) => (tk.time = Math.floor(Math.random() * 10))
      // );
      let i = 0;
      let count = 0;
      this.tasks.forEach((tk: Task) => {
        setTimeout(() => {
          tk.running = true;
          console.log("Rodando");
        }, tk.time * 1000);
      ...
      //     console.log("Rodando");
      //   }, this.tasks[i].time * 1000);
      //   setTimeout(() => {
      //     console.log("Rodando2");

      //     this.tasks[i].running = false;
      //   }, this.tasks[i].time * 2000);
      //   i++;
      // } while (i < this.tasks.length);
      // console.log("Task modificado", this.tasks, processQuant);
    },
